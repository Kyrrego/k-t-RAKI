...
@author: ubuntu
"""
from .utils.shapeAnalysis_ktUnder import extractDatCNN_ktUnder, fillDatCNN_ktUnder
from .utils.complexCNN_ktUnder import complexNet_ktUnder
...
def rakiReco_ktUnder(kspc_zf, acs, R, layer_design):
    '''
    ...
    prc_data = extractDatCNN_ktUnder(acs,
                                     R=R,
    ...
    net = complexNet_ktUnder(layer_design, R=R)
    ...
    network_reco = fillDatCNN_ktUnder(kspc_zf,
                                      kspc_pred,
                                      R,
                                      num_hid_layer=layer_design['num_hid_layer'],
                                      layer_design=layer_design)
