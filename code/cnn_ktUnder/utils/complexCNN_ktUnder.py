...
from .complexUtils_ktUnder import complex_conv_ktUnder
...
class complexNet_ktUnder(nn.Module):
    ...
    def __init__(self, layer_design, R):
        super(complexNet_ktUnder, self).__init__()
        # input layer: use customized kernel
        self.conv1 = complex_conv_ktUnder(in_channels=layer_design['input_unit'],
