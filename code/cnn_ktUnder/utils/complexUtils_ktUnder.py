...
class complex_conv_ktUnder(Module):
    '''
    Custom PyTorch 3D Convolution Layer to perform complex-valued convolutions. 
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride,
        ...
        super(complex_conv_ktUnder, self).__init__()
        
        mask_kernel = nn.Parameter(torch.tensor(mask_kernel, dtype=torch.float32))
        self.mask_kernel = nn.Parameter(mask_kernel, requires_grad=True)    # True or false?
